...
Crisp edges, clear z-depth, simple color choices, clear content blocking — the goal here is a visual language that emphasizes *composability.*
...
Graph-modeling boils down to taking page/chapter-oriented content and breaking it down into smaller, searchable, reusable, 'nodes' of data.
